...
- **Buyer Dashboard Cleanup**: Removed duplicate navigation cards (Notifications, Settings, Support) from buyer dashboard main page since they already exist in the sidebar. Dashboard now shows only My Orders, Wishlist, and Profile cards for cleaner UI. All navigation features remain accessible via the sidebar.
